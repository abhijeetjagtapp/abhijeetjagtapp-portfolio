...
using use = useUsing("use")`,
  ...
  [SkillNames.PYTHON]: {
    ...
    name: "python",
    label: "Python",
    shortDescription: "snek that crunches your data, no cap! 🐍📊",
    color: "#3776ab",
  ...
  [SkillNames.SQL]: {
    ...
    name: "sql",
    label: "SQL",
    shortDescription: "asking the database questions and it be spilling tea! ☕🗄️",
    color: "#00758f",
  ...
  [SkillNames.POWERBI]: {
    ...
    name: "powerbi",
    label: "Power BI",
    shortDescription: "turning spreadsheets into eye candy, periodt! 📈✨",
    color: "#f2c811",
  ...
  [SkillNames.DAX]: {
    ...
    name: "dax",
    label: "DAX",
    shortDescription: "measures so clean they hit different, deadass! 🧮🔥",
    color: "#f2c811",
    icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/powershell/powershell-original.svg",
  },
};
...
export const EXPERIENCE: Experience[] = [
  {
    ...
    company: "WoulibX",
    description: [
      "Performed EDA on ride-sharing datasets using Python (Pandas, NumPy), uncovering usage patterns and chatbot response accuracy issues that drove targeted data quality improvements.",
      "Built Power BI dashboards tracking key KPIs — ride completion rate, query resolution, and user retention — using DAX measures, calculated columns, and a star-schema model.",
      "Wrote complex SQL queries (CTEs, window functions like ROW_NUMBER, RANK, LAG, GROUP BY, HAVING) to transform operational data into reporting layers, replacing manual Excel workflows.",
      "Applied statistical preprocessing — outlier detection, missing-value imputation, distribution analysis — to raw transactional data, and engineered features for churn analysis using correlation heatmaps and Seaborn plots.",
    ],
    skills: [
      SkillNames.PYTHON,
      SkillNames.SQL,
